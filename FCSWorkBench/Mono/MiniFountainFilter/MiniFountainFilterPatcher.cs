...
namespace FCSTechFabricator.Mono.MiniFountainFilter
{
    internal class MiniFountainFilterCraftable : Craftable
    {
        ...
        public override string[] StepsToFabricatorTab { get; } = new[] { "AE", "MFF" };
        internal static TechType TechTypeID { get; private set; }

        public override CraftTree.Type FabricatorType { get; } =
            FCSTechFabricatorBuildable.TechFabricatorCraftTreeType;

        public MiniFountainFilterCraftable() : base("MiniFountainFilterKit_MFF", "Mini Fountain Filter Unit Kit",
            "This kit allows you to make one Mini Fountain Filter unit")
        {
            if (!GetPrefabs())
            {
