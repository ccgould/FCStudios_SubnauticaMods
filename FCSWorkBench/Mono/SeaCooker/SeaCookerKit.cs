...
{
    public partial class SeaCookerBuildable : Craftable
    {
        ...
        public SeaCookerBuildable() : base("SeaCookerBuildableKit_SC", "Sea Cooker Unit Kit", "This kit allows you to make one Sea Cooker unit")
        {
            if (!GetPrefabs())
            {
