...
using CyclopsUpgradeConsole.Utilities;
...
namespace CyclopsUpgradeConsole.Buildables
{
    internal partial class CUCBuildable
    {
        ...
        public static bool GetPrefabs()
        {
            try
            {
                if (!_initialized)
                {
                    ...
                    _assetBundle = CUCUtils.Asset(Mod.BundleName);
        ...
        internal static void ApplyShaders(GameObject prefab, AssetBundle bundle = null)
        {
            ...
            #region BaseColor
            Helpers.Helpers.ApplySpecShader(BodyMaterial, SpecTexture, prefab, 1, 3f, bundle);
            Helpers.Helpers.ApplyEmissionShader(BodyMaterial, LUMTexture, prefab, bundle, Color.white);
            Helpers.Helpers.ApplyNormalShader(BodyMaterial, NormalTexture,prefab,bundle);
            Helpers.Helpers.ApplyAlphaShader(DecalMaterial, prefab);
            Helpers.Helpers.ApplySpecShader("engine_console_key", "engine_console_key_01_spec", prefab, 1, 3f, bundle);
            Helpers.Helpers.ApplyEmissionShader("engine_console_key", "engine_console_key_01_illum", prefab, bundle, Color.white);
            Helpers.Helpers.ApplyNormalShader("engine_console_key", "engine_console_key_01_normal_N", prefab, bundle);
