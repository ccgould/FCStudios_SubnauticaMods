...
namespace FCSAlienChief.Items
{
    public class FoodItem : AlienChiefItem
    {
        ...
        /// </summary>
        public FoodItem(string ID, string friendlyName, string description, string itemIcon, int foodValue, int waterValue, int craftAmount, List<Ingredient> ingredients) : base(ID, $"{ID}Prefab")
        {
            ...
            // Set the recipe
            this.Recipe = ItemHelpers.CreateRecipe(craftAmount, ingredients);
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                prefabId.ClassId = $"{this.ClassID}Prefab";
