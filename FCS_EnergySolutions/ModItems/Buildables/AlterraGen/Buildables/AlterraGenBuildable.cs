...
internal class AlterraGenBuildable : FCSBuildableModBase
{
    public static TechType PatchedTechType { get; private set; }

    public AlterraGenBuildable() : base(PluginInfo.PLUGIN_NAME, "AlterraGen", FileSystemHelper.ModDirLocation, "AlterraGen", "AlterraGen")
    {
        OnStartRegister += () =>
        {
