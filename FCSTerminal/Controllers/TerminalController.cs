...
{
    public class TerminalController : HandTarget, IHandTarget, IProtoEventListener
    {
...
#endif
            File.WriteAllText(Path.Combine(saveFolder, "fcsterminal_" + id.Id + ".txt"), saveData);
        }
        ...
        public void OnProtoDeserialize(ProtobufSerializer serializer)
        {
            ...
            string filePath = Path.Combine(FilesHelper.GetSaveFolderPath(), "fcsterminal_" + id.Id + ".txt");
