...
using FCS_AlterraHub.Core.Systems.DroneSystem.Factory;
using FCS_AlterraHub.Core.Systems.DroneSystem.Interfaces;
using FCS_AlterraHub.Core.Systems.DroneSystem.StatesMachine;
using FCS_AlterraHub.Core.Systems.DroneSystem.StatesMachine.States;
...
internal class DroneController : MonoBehaviour
{
    ...
    private IEnumerator ShipOrderAsync(IShippingDestination destinationPort, bool isReturning)
    {
        ...
        departurePort = isReturning ? departurePort : AlterraHubLifePodDronePortController.main.PortManager;
