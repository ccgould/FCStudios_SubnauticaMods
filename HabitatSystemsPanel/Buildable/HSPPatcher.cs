...
namespace AE.HabitatSystemsPanel.Buildable
{
    ...
    internal partial class HSPBuildable : Buildable
    {
        private static readonly HSPBuildable Singleton = new HSPBuildable();

        //FCSAESeaCooker
        public HSPBuildable() : base(Mod.ClassID, Mod.FriendlyName, Mod.Description)
        {
        ...
        private static void Register()
        {
            if (_prefab != null)
            {
                ...
                _prefab.AddComponent<HSPController>();
            }
        }
    }
}
