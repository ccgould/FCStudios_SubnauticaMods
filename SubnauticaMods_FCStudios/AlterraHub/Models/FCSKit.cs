...
namespace FCS_AlterraHub.Models
{
    public class FCSKit : FCSSpawnableModBase
    {
        ...
        public FCSKit(string classID,string friendlyName,string iconPath) : base("AlterraHub", "MainConstructionKit", FileSystemHelper.ModDirLocation,$"{classID}_kit", $"{friendlyName} Kit")
        {
            _iconPath = iconPath;
        }
        ...
        {
            return ImageUtils.LoadSpriteFromFile(_iconPath);
        }
    }
}
