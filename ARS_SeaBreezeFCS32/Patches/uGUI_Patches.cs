...
namespace ARS_SeaBreezeFCS32.Patches
{
    // Code provided by PrimeSonic from repo : https://github.com/PrimeSonic/PrimeSonicSubnauticaMods/blob/MCU_4-0/CyclopsNuclearReactor/uGUI_Patches.cs
    ...
    internal class UGUI_InventoryTab_OnOpenPDA_Patcher
    {
        ...
        internal static void Postfix(uGUI_InventoryTab __instance)
        {
            ...
            FilterManager.ConnectToContainer(lookup); // Found!
        }
    }
}
