...
namespace FCS_ProductionSolutions.DeepDriller.Mono
{
    internal class FCSDeepDrillerDisplay : AIDisplay
    {
        ...
        {
            _itemCounter.text = $"{currentTotal} / {QPatch.DeepDrillerMk2Configuration.StorageSize}";
        }
        ...
        public override bool FindAllComponents()
        {
            try
            {
                ...
                _itemsGrid.Setup(9, ModelPrefab.DeepDrillerItemPrefab, itemsPage, _startColor, _hoverColor, OnButtonClick);
                ...
                _filterGrid.Setup(4, ModelPrefab.DeepDrillerListItemPrefab, settingsPage, _startColor, _hoverColor, OnButtonClick);
                ...
                _programmingGrid.Setup(6, ModelPrefab.DeepDrillerProgrammingItemPrefab, programmingPage, _startColor, _hoverColor, OnButtonClick);
