...
internal class HydroponicHarvesterMKIIBuildable : FCSBuildableModBase
{
    public TechType PatchedTechType { get; private set; }


    public HydroponicHarvesterMKIIBuildable() : base(PluginInfo.PLUGIN_NAME, "HydroponicHarvesterMKII", FileSystemHelper.ModDirLocation, "HydroponicHarvesterMKII", "Hydroponic Harvester MKII")
    {
        OnStartRegister += () =>
        {
